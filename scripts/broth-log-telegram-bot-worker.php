...
try {
    ...
    if (!$dryRun) {
        ...
        // Frees a station's suppressed-problem identity the moment a genuinely safe reading is
        // observed for it, so the next still-unsafe reading (if any) opens a real new incident
        // instead of staying folded into an old, already-auto_stopped one indefinitely.
        $stationSafeClears = broth_log_copilot_process_station_safe_clears();
    ...
    echo json_encode([
        ...
        'station_safe_clears' => $stationSafeClears,
